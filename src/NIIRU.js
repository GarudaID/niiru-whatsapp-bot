...
const _niiru = require('../lib/browser');
...
/**
 *niiru class for interact whit whatsapp web
 *
 * @class niiru
 * @extends {EventEmitter}
 * @param {object} opts - niiru options
 ...
 * 
 * @fires niiru#ready
 * @fires niiru#onStateChanged
 * @fires niiru#onMessageFromBloqued
 * @fires niiru#onMessageFromNoPrivileges
 * @fires niiru#waitNewAcknowledgements
 * @fires niiru#onBattery
 * @fires niiru#onPlugged
 * @fires niiru#onRemovedFromGroup
 * @fires niiru#onParticipantsChanged
 * @fires niiru#onMessageMediaUploadedEvent
 * @fires niiru#vcard
 * @fires niiru#message
 * @fires niiru#command
 */
class niiru extends EventEmitter {
    constructor(opts = {}){
        super();
        ...
        this._niiru.on('onMessageMediaUploadedEvent', (arg) => {
            /**
             * Emitted when media has been uploaded for a message sent by the client.
             * @event niiru#onMessageMediaUploadedEvent
             * @param {object} message - The message with media that was uploaded
             */
            this.emit('onMessageMediaUploadedEvent', arg);
        });

        this._niiru.on('ready', (session) => {
            this.isLogged = true;
            /**
             * Emitted when niiru is ready to work
             * @event niiru#ready
    ...
    sendMessage(args){
        ...
        if (data.isValid){
            this._niiru.sendMessage(data.data);
        }else {
    ...
    async downloadFile(idMessage){
        return new Promise(async (resolve, reject) => {
            this._niiru.downloadFile(idMessage)
            .then((file) => {
                resolve(file);
            })
            .catch((err) => {
     ...
     */
    async getWAVersion() {
        return this._niiru.getWAVersion();
    }
    ...
    async getBatteryLevel() {
        return this._niiru.getBatteryLevel();
    }
     ...
     */
    async getAllChats() {
        return this._niiru.getAllChats();
    }
    ...
    async getAllChatsWithNewMsg() {
        return this._niiru.getAllChatsWithNewMsg();
    }
    ...
    async getChatById(chatId) {
        return this._niiru.getChatById(chatId);
    }
    ...
    async getMessageById(messageId) {
        return this._niiru.getMessageById(messageId);
    }
    ...
    async getAllUnreadMessages() {
        return this._niiru.getAllUnreadMessages();
    }
    ...
    async getAllGroupMetadata() {
        return this._niiru.getAllGroupMetadata();
    }
    ...
    async getGroupMetadata(groupId) {
        return this._niiru.getGroupMetadata(groupId);
    }
    ...
    async createGroup(name, contactsId) {
        return this._niiru.createGroup(name, contactsId);
    }
    ...
    async getAllContacts() {
        return this._niiru.getAllContacts();
    }
     ...
     */
    async getMyContacts() {
        return this._niiru.getMyContacts();
    }
    ...
    async getContactById(contactId) {
        return this._niiru.getContactById(contactId);
    }
    ...
    async getInviteInfo(inviteCode) {
        return this._niiru.getInviteInfo(inviteCode);
    }
    ...
    async getGroupInviteLink(chatId) {
        return this._niiru.getGroupInviteLink(chatId);
    }
    ...
    async joinGroupViaLink(inviteCode) {
        return this._niiru.joinGroupViaLink(inviteCode);
    }
    ...
    async setStatusMessage(newStatus){
        return this._niiru.logout(newStatus);
    }
    ...
    async archiveChat(idChat, archive){
        return this._niiru.archiveChat(idChat, archive);
    }
    ...
    async setPresence(presence){
        return this._niiru.setPresence(presence);
    }
    ...
    async setDisplayName(newName){
        return this._niiru.setDisplayName(newName);
    }
    ...
    async validNumberExists(id){
        return this._niiru.validNumberExists(id);
    }
    ...
    async muteChat(chatId, unmuteDate) {
        this._niiru.muteChat(chatId, unmuteDate);
    }
    ...
    async pinChat(chatId) {
        return this._niiru.pinChat(chatId);
    }
    ...
    async unpinChat(chatId) {
        return this._niiru.unpinChat(chatId);
    }
    ...
    async archiveChat(chatId) {
        return this._niiru.archiveChat(chatId);
    }
    ...
    async unarchiveChat(chatId) {
        return this._niiru.unarchiveChat(chatId);
    }
